								...
								options: {
									...
									scales: {
										xAxes: [{
											...
											time: {
												 displayFormats: {
														'millisecond': 'DD.MM.YYYY HH:00',
													   'second': 'DD.MM.YYYY HH:00',
													   'minute': 'DD.MM.YYYY HH:00',
													   'hour': 'DD.MM.YYYY HH:00',
													   'day': 'DD.MM.YYYY HH:00',
													   'week': 'DD.MM.YYYY HH:00',
													   'month': 'DD.MM.YYYY HH:00',
													   'quarter': 'DD.MM.YYYY HH:00',
													   'year': 'DD.MM.YYYY HH:00',
												}
											},
											display: true,
											scaleLabel: {
